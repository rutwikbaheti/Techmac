...
$result="";
    ...
    {
        require 'phpmelir/PHPMailerAutoload.php';
        $mail=new PHPMailer;
        ...
        $mail->SMTPAuth=true;
        $mail->SMTPSecure='tls';
        $mail->Username='sourabhhawle108@gmail.com';
        $mail->pass='9021209108@';


        $mail->SetFrom($_POST['email']);
        $mail->addAddress('sourabhhawale9@gmail.com');
        ...
        if(!$mail->send()){
            $result="Something to wrong!!!!";
        }
        else{
            $result="Thanks".$_POST['name']."Contact us";
        }
    }
...
<head>
    ...
    <!-- Google fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Merriweather:ital,wght@1,300&display=swap" rel="stylesheet">
...
<body id="top-page">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#top-page">Techmac</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white font-weight-light mb-5">Start Bootstrap can help you build better websites using the Bootstrap framework! Just download a theme and start customizing, no strings attached!</p>
                    <a class="btn  btn-outline-light js-scroll-trigger" href="#about">Find Out More</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about-section" id="about">
        <div class="inner-container" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
            ...
            <div class="skills">
                <a class="btn btn-outline-primary js-scroll-trigger" href="#services">Get Started!</a>
            </div>
        </div>
    </div>
    ...
    <div class="page-section" id="services">
        <div class="container">
            <div class="text-center service-section">
                ...
                <hr class="divider my-4" />
                <h5 class="section-heading text-muted">Lorem ipsum dolor sit amet consectetur.</h5>
            </div>
            <ul class="timeline">
                <li>
                    <div class="timeline-image" data-aos="zoom-out-down"><img class="rounded-circle img-fluid" src="images/servi2.png" alt="" /></div>
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image" data-aos="zoom-out-down"><img class="rounded-circle img-fluid" src="images/servi1.png" alt="" /></div>
                ...
                <li>
                    <div class="timeline-image" data-aos="zoom-out-down"><img class="rounded-circle img-fluid" src="images/servi3.png" alt="" /></div>
                    <div class="timeline-panel" data-aos="fade-right">
                        <div class="timeline-heading">
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image" data-aos="zoom-out-down"><img class="rounded-circle img-fluid" src="images/servi4.png" alt="" /></div>
                    <div class="timeline-panel" data-aos="fade-left">
                        <div class="timeline-heading">
                            <h4 class="subheading">IT Services</h4>
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                        </div>
    ...
    <!--Info-->
    <section class="stories-area section-padding">
            <div class="container">
                <!-- Section title -->
        ...
        <div class="da-projects" id="projects">
            ...
            <div class="row mx-0">
                ...
                <div class="col-md-6 px-0 da-project-2" style="background-image: url('images/da-img-1.jpg');" data-aos="zoom-in"></div>
            </div>
        </div>
        <div class="da-expertise">
            <div class="row mx-0">
                <div class="col-md-6 px-0 da-exp-image" style="background-image: url('images/da-img-1.jpg');" data-aos="zoom-in"></div>
        ...
        <div class="container da-company-brand py-5">
            <div class="h3 pb-3 text-uppercase text-center section-heading" data-aos="fade-up">Technology WE Use</div>
            ...
            <div class="row">
              <div class="col-md-4 text-center"><img class="img-fluid" src="images/android.png" alt="Company Image 1"/></div>
              <div class="col-md-4 text-center"><img class="img-fluid" src="images/html.png" alt="Company Image 2"/></div>
              <div class="col-md-4 text-center"><img class="img-fluid" src="images//php.png" alt="Company Image 3"/></div>
    
            </div>
          </div>
        <!---->
        <div class="da-contact" id="contact">
            <div class="da-contact-detail"  data-aos-duration="1000">
                <div class="container">
                    <div class="h3 pb-3 text-uppercase text-center" data-aos="fade-up">Contact Us</div>
                                    ...
                                    <form action="index.html" method="POST" id="contact-form">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 mb-3">
                                                <input class="mr-3 form-control" type="text" name="name" placeholder="First Name" required="required" />
                                            </div>
                                            <div class="col-md-6 col-sm-12 mb-3">
